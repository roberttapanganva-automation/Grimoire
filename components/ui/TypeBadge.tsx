...
} satisfies Record<ItemType, { label: string; className: string; Icon: typeof BookOpen }>;
...
export function TypeBadge({ type }: TypeBadgeProps) {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 rounded-[4px] border px-2 py-1 text-xs font-medium ${className}`}
    >
